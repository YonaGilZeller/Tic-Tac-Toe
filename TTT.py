    ...
    def check_winner(self):
        if(self.board[0].text == self.board[1].text == self.board[2].text == "X" or
           ...
           self.board[2].text == self.board[4].text == self.board[6].text == "X"):
            popup = Popup(title="Game OVER", content=Label(text="X player WON"), size=(300, 100), size_hint=(None, None))
            popup.open()
           ...
           self.board[2].text == self.board[4].text == self.board[6].text == "O"):
            popup = Popup(title="GAME OVER", content=Label(text="O player WON"), size=(300, 100), size_hint=(None, None))
            popup.open()
